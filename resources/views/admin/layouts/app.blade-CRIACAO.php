            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky py-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (explode('.', Route::currentRouteName())[0] === 'category' ? 'active' : '') }}" href="{{ route('category.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (explode('.', Route::currentRouteName())[0] === 'product' ? 'active' : '') }}" href="{{ route('product.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (explode('.', Route::currentRouteName())[0] === 'client' ? 'active' : '') }}" href="{{ route('client.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (explode('.', Route::currentRouteName())[0] === 'user' ? 'active' : '') }}" href="{{ route('user.index') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                Usuários
                            </a>
                        </li>
